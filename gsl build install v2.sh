...
do
	...
	GSL_DIR=/c/OSRC/gsl/gsl_${GSL_VER}_gcc${GCC_VER_CODE}_${THREAD}_${EXCEPT}_${OSTYPE}_x${BITS}
    ...
    GCC_PATH=/c/OSRC/gcc-build/msys64/home/arkay7777/mingw-gcc-${GCC_VER}/${ARCH}-${GCC_VER_CODE}-${THREAD}-${EXCEPT}-${OSTYPE}-rt_${MINGW64_CRT}-rev${REV}/${MINGW32OR64}
