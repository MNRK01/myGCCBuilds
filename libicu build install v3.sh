...
do
    ...
    # define paths
    GCC_PATH=/home/arkay7777/mingw-gcc-${GCC_VER}/${BUILD_ARCH}-${GCC_VER_CODE}-${GCC_THREAD_EXCEPT}-rt_${MINGW64_CRT}-rev${REV}/${MINGW_DIR_32OR64}
    ...
    LIBICU_DIR=/c/OSRC/libicu-${ICU_VER_CODE}/libicu_${ICU_VER_CODE}_gcc${GCC_VER_CODE}_${BUILD_ARCH}_${GCC_THREAD_EXCEPT_DIR}_x${BITS}_rev${REV}
